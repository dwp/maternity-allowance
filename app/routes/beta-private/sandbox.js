...
router.post('/beta-private/sandbox/', function (req, res) {
  ...
  if (req.session.data['sandbox'] == 'add-employer') {
    ...
    req.session.data['ma-he-week-1'] = '30 Jan';
    req.session.data['ma-he-week-2'] = '6 Feb';
    req.session.data['ma-he-week-3'] = '13 Feb';
    req.session.data['ma-he-week-4'] = '20 Feb';
    req.session.data['ma-he-week-5'] = '27 Feb';
    req.session.data['ma-he-week-6'] = '6 Mar';
    req.session.data['ma-he-week-7'] = '13 Mar';
    req.session.data['ma-he-week-8'] = '20 Mar';
    req.session.data['ma-he-week-9'] = '27 Mar';
    req.session.data['ma-he-week-10'] = '3 Apr';
    req.session.data['ma-he-week-11'] = '10 Apr';
    req.session.data['ma-he-week-12'] = '17 Apr';
