...
router.post('/beta-private/iteration-11/', function (req, res) {
  ...
  if (req.session.data['scenario'] == 'scenario-1') {
    ...
    // Claimant information
    req.session.data['claimant-name'] = 'Jamie Taylor';
    req.session.data['claimant-nino'] = 'XX123456X';
    req.session.data['claimant-dob'] = '25 October 1989';
    req.session.data['claimant-postcode'] = 'HR7 8RP';
    req.session.data['claimant-address'] = null;
    ...
    // Claimant information
    req.session.data['claimant-name'] = 'Faye Thomas';
    req.session.data['claimant-nino'] = 'XX123456X';
    req.session.data['claimant-dob'] = '25 October 1989';
    req.session.data['claimant-postcode'] = 'HR7 8RP';
    req.session.data['claimant-address'] = null;
  ...
  res.redirect('/beta-private/iteration-11/scenario-1/');
});
...
router.post('/beta-private/iteration-11/scenario-1/start-a-claim/about-the-baby', function (req, res) {
  if (req.session.data['baby-born'] == 'yes') {
    ...
    res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/');
  }
});
...
router.post('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/', function (req, res) {
  if (req.session.data['stopped-work'] == 'yes') {
    res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/reason');
  }
  else {
...
router.post('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/reason', function (req, res) {
  if (req.session.data['stopped-work-reason'] == 'sick') {
    res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/sickness/pregnancy-related');
  }
  else {
    res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/date-last-worked');
  }
});

router.post('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/sickness/pregnancy-related', function (req, res) {
    res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/sickness/allowance-type');
});

router.post('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/sickness/allowance-type', function (req, res) {
  if (req.session.data['allowance-type'] == 'statutory-sick-pay') {
    res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/sickness/benefit-end-date');    
  }
  else {
    res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/sickness/benefit-start-date');
  }
});

router.post('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/sickness/benefit-end-date', function (req, res) {
  res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/date-last-worked');
});

router.post('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/sickness/benefit-start-date', function (req, res) {
    res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/date-last-worked');
});

router.post('/beta-private/iteration-11/scenario-1/start-a-claim/stopped-work/date-last-worked', function (req, res) {
    res.redirect('/beta-private/iteration-11/scenario-1/start-a-claim/chosen-map-date');
});
