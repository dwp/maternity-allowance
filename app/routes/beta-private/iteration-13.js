...
router.post('/beta-private/iteration-13/sandbox/', function (req, res) {
  ...
  if (req.session.data['sandbox'] == 'add-employer') {
    ...
    res.redirect('/beta-private/iteration-13/sandbox/add-employer'); 
  } else {
    res.redirect('/beta-private/iteration-13/sandbox/copy-button-summary');
  }
